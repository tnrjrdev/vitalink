...
public class InsurancePlanController {
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'INSURER')")
    @Operation(summary = "Reativa um plano de saude inativado")
    public ResponseEntity<InsurancePlanResponse> activate(@PathVariable UUID id) {
        return ResponseEntity.ok(insurancePlanService.activate(id));
    }
}
