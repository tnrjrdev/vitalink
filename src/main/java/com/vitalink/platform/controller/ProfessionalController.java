...
public class ProfessionalController {
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'HOSPITAL', 'CLINIC')")
    @Operation(summary = "Reativa um profissional inativado")
    public ResponseEntity<ProfessionalResponse> activate(@PathVariable UUID id) {
        return ResponseEntity.ok(professionalService.activate(id));
    }
}
