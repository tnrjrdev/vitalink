...
/**
 * tratamento global e centralizado de excecoes (Clean Code: erros tratados em
 * um unico ponto, fora dos controllers). Converte excecoes em respostas
 * {@link ApiError} consistentes e registra logs estruturados.
 */
@Slf4j
...
public class GlobalExceptionHandler {
    ...
    /** Erros de validacao de corpo (@Valid em @RequestBody). */
    ...
    /** Erros de validacao de parametros (@Validated em @RequestParam/@PathVariable). */
    ...
    /** Rede de seguranca: qualquer excecao nao mapeada vira 500 sem vazar stacktrace. */
    ...
    private String extractPath(WebRequest request) {
        // WebRequest.getDescription devolve "uri=/caminho"
