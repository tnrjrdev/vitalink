...
/**
 * provedor de tokens JWT: geracao e validacao de access/refresh tokens
 * assinados com HMAC-SHA512.
 *
 * <p>O "subject" do token e o id (UUID) do usuario. Um claim {@code type}
 * diferencia access de refresh, impedindo que um refresh token seja aceito
 * como credencial de acesso a recursos.</p>
 */
@Slf4j
@Component
public class JwtTokenProvider {
    ...
    private SecretKey buildKey(String secret) {
        ...
        try {
            ...
            // permite chaves em texto puro em ambientes de desenvolvimento.
    ...
    /** expiracao do access token em segundos (devolvida ao cliente). */
     ...
     *
     * @return {@code true} se valido; {@code false} caso contrario (log em nivel adequado)
     */
